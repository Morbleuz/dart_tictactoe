...
class Tictactoe {
  ...
  bool fini() {
    ...
    //Vertical milieu
        ...
        this._plateau.getList()[0][1] == this._plateau.getList()[1][2]) {
      fini = true;
    }
    //Vertial droite
    ...
    //Diagonale droite
    else if (this._plateau.getList()[2][2] != " " &&
        this._plateau.getList()[2][2] == this._plateau.getList()[1][1] &&
        this._plateau.getList()[2][2] == this._plateau.getList()[0][2]) {
      fini = true;
    }
    return fini;
  }
